      ...
      <div className="p-6 bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
          <div className="flex justify-center p-4 bg-gray-100">
            <img
              src={product.image_url} // Updated from product.images to product.image_url.
              alt={product.name}
            ...
            <div className="mt-4 flex flex-row flex-wrap gap-6">
              ...
              <div className="flex-1 min-w-[300px]">
                ...
                <p className="text-gray-600 mt-2">
                  Contact: {vendors[0]?.contact_details || "Not Provided"}
                </p>
              </div>
              ...
              <div className="flex-1 min-w-[300px]">
                ...
                <p className="mt-2 text-gray-600">
                  Shipping Address:{" "}
                  {vendors[0]?.shipping_address || "Not Provided"}
                </p>
                <p className="text-gray-600 mt-2">
                  Shipping Policy:{" "}
                  {vendors[0]?.shipping_policy || "Not Provided"}
                </p>
                <p className="text-gray-600 mt-2">
                  Return Policy: {vendors[0]?.return_policy || "Not Provided"}
                </p>
              </div>
              ...
              <div className="flex-1 min-w-[300px]">
                ...
                <p className="mt-2 text-gray-600">
                  Mpesa Number: {vendors[0]?.bank_details || "Not Provided"}
                </p>
              </div>
